...
public class SimpleChestBoat extends ChestBoat implements BoatTypeAccessor {
    private static final EntityDataAccessor<Holder<BoatType>> BOAT_TYPE = SynchedEntityData.defineId(SimpleChestBoat.class, SimpleEntityDataSerializers.BOAT_TYPES.get());

    public SimpleChestBoat(EntityType<? extends SimpleChestBoat> entityType, Level level) {
        super(entityType, level);
    }

    public SimpleChestBoat(Level level, double x, double y, double z) {
        this(SimpleEntityTypes.SIMPLE_CHEST_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return this.getBoatType().value().chestBoat().value();
    }
